...
\begin{figure}[h]
  ...
  \captionsetup{justification=centering}
      \includegraphics[width=1\textwidth]{image/gambar1.png}
...
Seluruh source code LaTeX proposal tugas akhir ini tersedia di repository GitHub berikut:
\url{https://github.com/rafidhiyaulh/Proposal-Tugas-Akhir}
