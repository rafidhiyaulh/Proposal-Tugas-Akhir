...
% Email: [baskara@itb.ac.id](mailto:baskara@itb.ac.id) 
% 
...
%   [https://ctan.org/pkg/biblatex-chicago](https://ctan.org/pkg/biblatex-chicago)
% - Untuk referensi lebih lanjut tentang penggunaan XeLaTeX dan fontspec, silakan merujuk ke dokumentasi resmi fontspec.
%   [https://ctan.org/pkg/fontspec](https://ctan.org/pkg/fontspec)
...
\begin{center}
    ...
    {\Large\bfseries Peningkatan Akurasi Prediksi PM10 Jakarta Menggunakan Model Hybrid Random Forest-ARIMA Berbasis Feature Engineering}\\
     \vspace{4cm}
    ...
    {\large Oleh}\\[0.3cm]
    \textbf{
    {\large Muhammad Rafi Dhiyaulhaq}\\
    {\large 18222069}
    }\\
